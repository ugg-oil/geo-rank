...
const en = {
  ...
  home: {
    ...
    why2: "GEO Radar shows your mention frequency and rank trend across that shortlist.",
...
const zh = {
  ...
  home: {
    ...
    why2: "GEO Radar 展示你在那份短名单里的提及频率与排名趋势。",
  ...
  rankings: {
    ...
    categoriesCount: "13 个品类",
    leaderThisWeek: "本周期 #1",
  },
  category: {
