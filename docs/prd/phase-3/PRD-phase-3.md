...
> 本文档记录第三阶段已实现上线的功能（v1.3），不再作为后续需求清单。实现、门闩、重跑与流程图见 [technical.md](./technical.md)。v1.4 已发布见 [PRD-phase-4.md](../phase-4/PRD-phase-4.md)；当前开发见 [PRD-phase-5.md](../phase-5/PRD-phase-5.md)；未排期见 [PRD-phase-next.md](../PRD-phase-next.md)。
>
> 最后核对：2026-08-06
